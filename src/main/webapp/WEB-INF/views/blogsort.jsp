...
<%-- 			<form:form  action="blogtag"  method="GET"> --%>
		...
		<a href="backbp?id=${firstId}"  ><img alt="money" src="/myblogg/resources/images/pleft.png" width="60" height="60"></a>Previus 5 entries &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Next 5 entries<a href="forwardbp?id=${lastId}"  ><img alt="money" src="/myblogg/resources/images/pright.png" width="60" height="60"></a>
